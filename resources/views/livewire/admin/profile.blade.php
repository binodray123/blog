        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
            <div class="pd-20 card-box height-100-p">
                <div class="profile-photo">
                    ...
                    ('profilePictureFile').click();" class="edit-avatar"><i class="fa fa-pencil"></i></a>
                    <img src="{{ $user->picture }}" alt="{{$user->name}}" class="avatar-photo" id="profilePicturePreview">
                    ...
                    <div class="tab height-100-p">
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <li class="nav-item">
                                ...
                                $tab == 'personal_details' ? 'active' : ''}}" href="#personal_details" data-toggle="tab" role="tab">Personal Details</a>
                            </li>
                            <li class="nav-item">
                                <a wire:click="selectTab('update_password')" class="nav-link {{
                                $tab == 'update_password' ? 'active' : ''}}" href="#update_password" data-toggle="tab" role="tab">Update Password</a>
                            </li>
                            <li class="nav-item">
                                <a wire:click="selectTab('social_links')" class="nav-link {{
                                $tab == 'social_links' ? 'active' : ''}}" href="#social_links" data-toggle="tab" role="tab">Social Links</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" wire:model="email" placeholder="Enter your email address" disabled>
                                                    @error('email')
                                                    <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="">Bio</label>
                                                    <textarea wire:model="bio" cols="4" rows="4" class="form-control" placeholder="Type your bio..." id=""></textarea>
                                                    @error('bio')
                                                    <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                            ...
                            <div class="tab-pane fade {{ $tab == 'social_links' ? 'show active' : ''}}" id="social_links" role="tabpanel">
                                <div class="pd-20 profile-task-wrap">
                                    <form wire:submit.prevent='updateSocialLinks' method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
